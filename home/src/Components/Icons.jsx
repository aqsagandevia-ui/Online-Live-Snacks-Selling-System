...
export const IconHeart = ({ size = 20, fill = 'none', color = 'currentColor', className = '' }) => (
...
export const IconStar = ({ size = 16, fill = '#f59e0b', color = '#f59e0b', className = '' }) => (
...
export const IconPackage = ({ size = 20, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
